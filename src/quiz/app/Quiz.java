...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        this.name = name;
        setBounds(05, -10, 1340, 850);
        getContentPane().setBackground(Color.pink);//background color
        setUndecorated(true);
        setLayout(null);


        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/javaimg.png"));
        JLabel image = new JLabel(i1);
        image.setBounds(0, 15, 1300, 420);
        add(image);
        ...
        questions[0][0] = "Founder of Java";
        questions[0][1] = "M Brus";
        questions[0][2] = "A K Kakade";
        questions[0][3] = "James Goslling";
        questions[0][4] = "R J Robert";
